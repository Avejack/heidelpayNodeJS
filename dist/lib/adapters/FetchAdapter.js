...
var FetchAdapter = /** @class */ (function () {
    function FetchAdapter(locale, env) {
        ...
        switch (env) {
            case 'development':
                argsConfig = Environment_1.default['development'];
                break;
            case 'staging':
                argsConfig = Environment_1.default['staging'];
                break;
            default:
                argsConfig = Environment_1.default['production'];
        }
        var config = {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        fetch(requestUrl, __assign({ headers: {
                                'SDK-TYPE': Version_1.SDK_TYPE,
                                'SDK-VERSION': Version_1.SDK_VERSION,
