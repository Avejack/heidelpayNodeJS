...
exports.default = (function (hirePurchaseId, args, paymentService) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService
                            .getRequestAdapter()
                            .put(apiURL.URL_TYPE_HIRE_PURCHASE + "/" + hirePurchaseId, payload, paymentService.getHeidelpay().getPrivateKey())];
                case 1:
                    response = _a.sent();
                    hirePurchase = new HirePurchase_1.default();
...
//# sourceMappingURL=UpdateHirePurchase.js.map