...
var Shipment_1 = require("../payments/business/Shipment");
var Utils = require("../utils/Utils");
exports.default = (function (paymentId, args, paymentService) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService.getRequestAdapter().post(Utils.replaceUrl(apiURL.URL_PAYMENT_SHIPMENT, {
                            paymentId: paymentId,
                ...
                case 1:
                    ...
                    shipment = new Shipment_1.default(paymentService.getHeidelpay());
                    // Set shipment Id
