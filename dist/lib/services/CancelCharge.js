...
var Cancel_1 = require("../payments/business/Cancel");
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService.getRequestAdapter().post(Utils.replaceUrl(apiURL.URL_PAYMENT_CHARGE_CANCEL, {
                            paymentId: paymentId,
                            chargeId: chargeId,
                ...
                case 1:
                    ...
                    cancel = new Cancel_1.default(paymentService.getHeidelpay());
                    // Set cancel Id
...
//# sourceMappingURL=CancelCharge.js.map