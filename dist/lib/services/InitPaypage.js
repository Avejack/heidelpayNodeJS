...
exports.default = (function (paypage, type, paymentService) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService
                            .getRequestAdapter()
                            .post(type === 'authorize' ? apiURL.URL_PAYPAGE_AUTHORIZE : apiURL.URL_PAYPAGE_CHARGE, payload, paymentService.getHeidelpay().getPrivateKey())
...
//# sourceMappingURL=InitPaypage.js.map