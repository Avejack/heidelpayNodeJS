...
exports.default = (function (paymentService, webhookId) {
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var endpoint, response, webhook, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    endpoint = webhookId ? apiURL.URL_WEBHOOK + "/" + webhookId : apiURL.URL_WEBHOOK;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
...
//# sourceMappingURL=FetchWebhook.js.map