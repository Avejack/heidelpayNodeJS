...
var HirePurchasePlan_1 = require("../payments/types/HirePurchasePlan");
var ResponseErrorsMapper_1 = require("./mappers/ResponseErrorsMapper");
exports.default = (function (amount, currency, effectiveInterestRate, orderDate, paymentService) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService
                            .getRequestAdapter()
                            .get(apiURL.URL_TYPE_HIRE_PURCHASE_PLANS + "/?amount=" + amount + "&currency=" + currency + "&effectiveInterest=" + effectiveInterestRate + "&orderDate=" + orderDate, paymentService.getHeidelpay().getPrivateKey())
                ...
                case 1:
                    ...
                    response.entity.map(function (item) {
                        ...
                        var hirePurchasePlan = new HirePurchasePlan_1.default();
...
//# sourceMappingURL=FetchHirePurchasePlan.js.map