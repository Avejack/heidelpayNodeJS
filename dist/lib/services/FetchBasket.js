...
exports.default = (function (basketId, paymentService) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, paymentService
                            .getRequestAdapter()
                            .get(apiURL.URL_BASKET + "/" + basketId, paymentService.getHeidelpay().getPrivateKey())];
                case 1:
                    response = _a.sent();
                    newBasket_1 = new Basket_1.default();
...
//# sourceMappingURL=FetchBasket.js.map