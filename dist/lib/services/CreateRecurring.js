...
var Recurring_1 = require("../payments/business/Recurring");
var ResponseErrorsMapper_1 = require("./mappers/ResponseErrorsMapper");
exports.default = (function (typeId, args, paymentService) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, paymentService
                            .getRequestAdapter()
                            .post(Utils.replaceUrl(apiURL.URL_RECURRING, {
                            typeId: typeId,
                ...
                case 2:
                    ...
                    newRecurring = new Recurring_1.default();
